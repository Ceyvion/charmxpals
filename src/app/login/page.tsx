      ...
      <div className="relative z-10 flex min-h-screen flex-col justify-center px-4 py-16">
        <div className="cp-container max-w-5xl">
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <section className="relative overflow-hidden rounded-3xl border border-white/20 bg-white/70 px-10 py-12 shadow-[0_40px_140px_rgba(110,206,242,0.22)] backdrop-blur-xl">
              ...
              <span className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/80 px-4 py-1 text-xs font-semibold uppercase tracking-wide text-white/80">
            ...
            <section className="relative flex flex-col justify-center rounded-3xl border border-white/20 bg-white/80 px-8 py-10 shadow-[0_30px_120px_rgba(110,206,242,0.2)] backdrop-blur-2xl">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-xl border border-white/10 bg-white/90 px-4 py-3 text-sm text-white shadow-inner focus:border-amber-400 focus:ring-2 focus:ring-amber-300/40 placeholder:text-slate-400"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="••••••••••"
                      className="w-full rounded-xl border border-white/10 bg-white/90 px-4 py-3 text-sm text-white shadow-inner focus:border-sky-300 focus:ring-2 focus:ring-sky-200/40 placeholder:text-slate-400"
                    />
                  </div>
                  {error && (
